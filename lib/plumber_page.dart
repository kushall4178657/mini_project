...
class _PlumberPageState extends State<PlumberPage> {
  plumber_Service? selectedService;
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        PlumberPage.final_service = services[index];
                        selectService(
                            services[index]); // Update selected service
                        // Navigator.push(
                        //   context,
                        //   MaterialPageRoute(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            // Add checkmark icon if the service is selected
